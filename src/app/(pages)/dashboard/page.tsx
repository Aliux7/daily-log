...
const page = () => {
  ...
  return (
    <div className="w-full h-full relative flex justify-center items-start m-0 p-0 overflow-hidden">
      ...
      <div
        className={`absolute top-10 ${
          openUpload ? "right-10" : "-right-[30rem]"
        } w-72 h-auto bg-gray-50 border border-gray-300 shadow-md flex flex-col justify-center items-start text-center rounded-xl transition-all duration-300 ease-in-out`}
      >
        <IoClose
          className="absolute top-3 right-3 text-gray-500 w-5 h-5 cursor-pointer"
          onClick={() => setOpenUpload(false)}
        />
        <div className="w-full h-full py-5 rounded-2xl gap-3 grid">
          ...
          <div className="grid gap-2">
            <div className="flex items-center justify-center">
              <label>
                ...
                <div className="flex w-28 h-9 px-2 flex-col bg-indigo-600 rounded-full text-white text-xs font-semibold leading-4 items-center justify-center cursor-pointer ">
                  Pilih Gambar
                </div>
              </label>
            </div>
